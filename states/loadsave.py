...
class Loadsave:
    ...
    def run(self):
        ...
        if self.onbutton is 1:
        ...
        elif self.onbutton is 4:
            self.d1_target_size = 0.2
            self.s1_target_size = 1.2
            self.p1_x = self.s1_x - 60
            self.s1_target_x = width//2
            self.s1_target_y = height//2
            ...
            self.s3_target_size = 0.1
            self.s3_target_y = 170
        elif self.onbutton is 5:
            self.d1_target_size = 0
            self.s1_target_size = 0.1
            self.s1_target_y = 170
            self.d2_target_size = 0.2
            self.s2_target_size = 1.2
            self.p2_x = self.s2_x - 60
            self.d3_target_size = 0
            self.s3_target_size = 0.1
            self.s3_target_y = 550
        elif self.onbutton is 6:
            self.d1_target_size = 0
            self.s1_target_size = 0.1
            self.s1_target_y = 550
            self.d2_target_size = 0
        ...
        self.play1_button = bf.Button(self.p1_x, self.s1_y, a.play1_img, a.play1down_img, self.p1_size)
        self.play2_button = bf.Button(self.p2_x, self.s2_y, a.play2_img, a.play2down_img, self.p2_size)
        self.play3_button = bf.Button(self.p3_x, self.s3_y, a.play3_img, a.play3down_img, self.p3_size)
        ...
        if self.gameStateManager.get_theme() is "load":
        ...
        if self.gameStateManager.get_theme() is "save":
            ...
            if save1check:
                ...
                if not self.confirm:
                    ...
                    if s1_button_clicked and self.onbutton is 0:
                        self.onbutton = 4
                        self.button_click_time = current_time
                    if self.onbutton is 4 and d1_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.delete = True
                            self.confirm = True
                            self.save_num = 1
                    elif self.onbutton is 4 and p1_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.confirm = True
                            self.load = True
                            self.save_num = 1
                    if self.s1_button.rect.collidepoint(pos) is False and self.onbutton is 4:
                        self.onbutton = 0
                ...
                if not self.confirm:
                    ...
                    if s1_button_clicked and self.onbutton is 0:
                        self.onbutton = 4
                        self.button_click_time = current_time
                    if self.onbutton is 4 and s1_button_clicked:
                        if current_time - self.button_click_time >= 200:
            ...
            if save2check:
                ...
                if not self.confirm:
                    ...
                    if s2_button_clicked and self.onbutton is 0:
                        ...
                        self.onbutton = 5
                        self.button_click_time = current_time
                    elif self.onbutton is 5 and d2_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.delete = True
                            self.confirm = True
                            self.save_num = 2
                    elif self.onbutton is 5 and p2_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.confirm = True
                            self.load = True
                            self.save_num = 2
                    elif self.s2_button.rect.collidepoint(pos) is False and self.onbutton is 5:
                        self.onbutton = 0
            else:
                if not self.confirm:
                    if self.s2_button in self.buttons:
                    ...
                    if s2_button_clicked and self.onbutton is 0:
                        ...
                        self.onbutton = 5
                        self.button_click_time = current_time
                    elif self.onbutton is 5 and s2_button_clicked:
                        if current_time - self.button_click_time >= 200:
            ...
            if save3check:
                ...
                if not self.confirm:
                    ...
                    if s3_button_clicked and self.onbutton is 0:
                        ...
                        self.onbutton = 6
                        self.button_click_time = current_time
                    elif self.onbutton is 6 and d3_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.delete = True
                            self.confirm = True
                            self.save_num = 3
                    elif self.onbutton is 6 and p3_button_clicked:
                        if current_time - self.button_click_time >= 200:
                            self.confirm = True
                            self.load = True
                            self.save_num = 3
                    elif self.s3_button.rect.collidepoint(pos) is False and self.onbutton is 6:
                        self.onbutton = 0
            else:
                if not self.confirm:
                    if self.s3_button in self.buttons:
                    ...
                    if s3_button_clicked and self.onbutton is 0:
                        ...
                        self.onbutton = 6
                        self.button_click_time = current_time
                    elif self.onbutton is 6 and s3_button_clicked:
                        if current_time - self.button_click_time >= 200:
        ...
        if self.gameStateManager.get_state() is not "loadsave" or self.del_true == True:
            self.fade_alpha = 255
            self.del_true = False
        if self.gameStateManager.get_state() is not "loadsave":
            self.onbutton = 0
            self.confirm = False
